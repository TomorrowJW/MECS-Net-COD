...
if __name__ == '__main__':
    ...
    swin.load_state_dict(
        torch.load('../pre_train/swinv2_base_patch4_window12to24_192to384_22kto1k_ft.pth')['model'],strict=True)
    features = swin(b)
    # print(len(features))
    print(features[0].shape) #[b,128,96,96]
    print(features[1].shape) #[b,256,48,48]
    print(features[2].shape) #[b,512,24,24]
    print(features[3].shape) #[b,1024,12,12]
    print(features[4].shape) #[b,1024,12,12]
