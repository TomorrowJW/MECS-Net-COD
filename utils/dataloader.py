...
class CamObjDataset(data.Dataset):
    def __init__(self, config, image_root, gt_root, edge_root, trainsize):
...
class test_dataset:
    ...
    def __init__(self, config, image_root, gt_root, testsize):
...
def get_loader(config, image_root, gt_root, edge_root, batchsize, trainsize, shuffle=True, num_workers=4, pin_memory=True):
    dataset = CamObjDataset(config, image_root, gt_root, edge_root, trainsize)
